...
static IdentifierMeta Identifiers[] = {
	...
	{ "br",    TT_Instruction, { TDT_InstructionMeta, .instruction_meta = { IF_Offset9, 0x0000 } } },
	{ "brn",   TT_Instruction, { TDT_InstructionMeta, .instruction_meta = { IF_Offset9, 0x0800 } } },
	{ "brnp",  TT_Instruction, { TDT_InstructionMeta, .instruction_meta = { IF_Offset9, 0x0A00 } } },
	{ "brnz",  TT_Instruction, { TDT_InstructionMeta, .instruction_meta = { IF_Offset9, 0x0C00 } } },
	{ "brnzp", TT_Instruction, { TDT_InstructionMeta, .instruction_meta = { IF_Offset9, 0x0E00 } } },
	{ "brp",   TT_Instruction, { TDT_InstructionMeta, .instruction_meta = { IF_Offset9, 0x0200 } } },
	{ "brz",   TT_Instruction, { TDT_InstructionMeta, .instruction_meta = { IF_Offset9, 0x0400 } } },
	{ "brzp",  TT_Instruction, { TDT_InstructionMeta, .instruction_meta = { IF_Offset9, 0x0600 } } },
	{ "getc",  TT_WordLiteral, { TDT_Word, .word = 0xF020 } },
	{ "halt",  TT_WordLiteral, { TDT_Word, .word = 0xF025 } },
	{ "in",    TT_WordLiteral, { TDT_Word, .word = 0xF023 } },
	{ "jmp",   TT_Instruction, { TDT_InstructionMeta, .instruction_meta = { IF_BaseR, 0xC000 } } },
	{ "jsrr",  TT_Instruction, { TDT_InstructionMeta, .instruction_meta = { IF_BaseR, 0x4000 } } },
	{ "ld",    TT_Instruction, { TDT_InstructionMeta, .instruction_meta = { IF_DestOffset, 0x2000 } } },
	{ "ldi",   TT_Instruction, { TDT_InstructionMeta, .instruction_meta = { IF_DestOffset, 0xA000 } } },
	...
	{ "ret",   TT_WordLiteral, { TDT_Word, .word = 0xC1C0 } },
	{ "rti",   TT_WordLiteral, { TDT_Word, .word = 0x8000 } },
	{ "st",    TT_Instruction, { TDT_InstructionMeta, .instruction_meta = { IF_DestOffset, 0x3000 } } },
	{ "sti",   TT_Instruction, { TDT_InstructionMeta, .instruction_meta = { IF_DestOffset, 0xB000 } } },
	{ NULL,    0,              { TDT_Void, { 0 } } },
};
